...
context.timeout = 20
inputArray = [
	  ["3 1 1 0 0 3 0 0 2 0 0", 
	   "4 2 0 0 1 0 2 0 0 2 0 0 0 4", 
	   "5 4 5 0 2 0 3 0 0 0 5 0 0 0 1 0 0", 
	   "7 3 2 6 0 1 0 0 5 0 0 2 0 0 3 0 0 0 4 0 0 0 7"]
	, ["1 2 add 3 mul", 
...
outputArray = [
	  ["1 2 1 3 1 3 2 3 2", 
	   "2 3 1 4 2 1 3 2 4 1 3 4", 
	   "-1", 
	   "2 6 3 1 2 4 5 1 3 2 4 7 3 5 6 7 4 1 5 6 7"]
	, ["9", "63", "48345", "85560"]
	, ["27", "120125", "954"]
...
executables = ["./cerinta", "./cerinta2", "./cerinta3", "./cerinta4"]
